...
const CropDocumentation = () => {
  ...
  const [formData, setFormData] = useState({
    hasCertification: activityData
      ? activityData.hasCertification ?? null
      : null,
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      navigation.reset({
        index: 0,
        routes: [{ name: "CropScreen", params: { crop } }],
      });
    } catch (e) {
  ...
  return (
    ...
    >
      ...
      <Text style={[cropStyle.titleCropIcons, { fontFamily: "QuicksandBold" }]}>
        Archivos/fotos adjuntos
      </Text>
      ...
      >
        ...
        <TouchableOpacity
          onPress={takePhoto}
          style={cropStyle.buttonIconContainer}
        >
